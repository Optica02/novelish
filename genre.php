...
$qry="select genreName from genre where genreID='".$_GET['genreID']."'";
$result=$con->query($qry);
$genre=$result->fetch_assoc();
$qry="select * from books where genreID='".$_GET['genreID']."' limit 8";
$result=$con->query($qry);
...
<section class="px-20 py-10 bg-blue-50">
    ...
    <div class=" relative">
        <div class="flex justify-center relative z-10">
            <h2 class="bg-blue-50 px-2 text-blue-800 text-2xl font-bold capitalize"><?php echo $genre['genreName'] ?></h2>
        </div>
        ...
        <div class=" justify-center mt-10">
          ...
          ?>
          <div>
            <h2 class="text-red-500 text-center font-bold text-xl ">Books Coming Soon...!!</h2>
          </div>
          <?php
          }
          ?>
