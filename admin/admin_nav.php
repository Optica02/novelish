    ...
    <div class="bg-[#061638] w-[20%] fixed text-white flex md:block md:px-6 top-0 left-0 bottom-0" id="sidebarnav">
        <div class="mx-auto md:mx-0 flex-col">
            ...
            <ul class="pt-10 space-y-4 text-lg" id="menu">
                ...
                <li class="hover:text-[#fe5d13] hover:border-l-4 hover:border-l-[#fe5d13]" id="genre">
                    <a href="../genre/" class="px-2">
                        <i class="fas fa-list"></i>
                        <span class="sidbarNavItemName hidden lg:inline-block ml-1">Genre</span></a>
                </li>
                ...
                <li class="hover:text-[#fe5d13] hover:border-l-4 hover:border-l-[#fe5d13]" id="books">
                    <a href="../users/" class="px-2">
                        <i class="fas fa-users"></i>
                        <span class="sidbarNavItemName hidden lg:inline-block ml-1">Users</span></a>
                </li>
                <li class="hover:text-[#fe5d13] hover:border-l-4 hover:border-l-[#fe5d13]" id="books">
                    <a href="../authors/" class="px-2">
                        <i class="fas fa-users"></i>
                        <span class="sidbarNavItemName hidden lg:inline-block ml-1">Approved Authors</span></a>
                </li>
                <li class="hover:text-[#fe5d13] hover:border-l-4 hover:border-l-[#fe5d13]" id="books">
                    <a href="../authors/pending_author.php" class="px-2">
                        <i class="fas fa-users"></i>
                        <span class="sidbarNavItemName hidden lg:inline-block ml-1">Pending Authors</span></a>
                </li>
                <li class="hover:text-[#fe5d13] hover:border-l-4 hover:border-l-[#fe5d13]" id="books">
                    <a href="../feedback" class="px-2">
                        <i class="fas fa-comment"></i>
                        <span class="sidbarNavItemName hidden lg:inline-block ml-1">feedback</span></a>
                </li>
