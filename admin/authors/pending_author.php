...
$qry = "SELECT * from users where role='Author' and is_approved=0";
...
<div class="lg:py-20  mt-7 lg:mt-0 transition-all duration-1000 ease  text-center md:text-left ml-[21%] mr-[5%]" id="mainarea">
    <h1 class="text-xl font-bold text-[#061638]">Pending Authors</h1>
                ...
                ?>
                        ...
                        <tr>
                            ...
                            <td class="w-[14%] flex gap-2">
                                ...
                                <a class="bg-red-600 hover:bg-red-800 text-white rounded-lg px-4 py-2 cursor-pointer text-lg font-semibold delete" id="<?php echo $row['userID'] ?>"><i class="far fa-times"></i></a>
                            </td>
                        </tr>
