...
$qry = "SELECT * from users where role='Author' and is_approved=1";
...
<div class="lg:py-20  mt-7 lg:mt-0 transition-all duration-1000 ease  text-center md:text-left ml-[21%] mr-[5%]"
    id="mainarea">
    <h1 class="text-xl font-bold text-[#061638]">Authors</h1>
          ...
          if ($result->num_rows > 0) {
            ...
            ?>
                ...
                <tr>
                    ...
                    <td class="w-[14%]">
                        <a class="py-2" href="book.php?id=<?php echo $row['userID']?>&author=<?php echo $row['name'] ?>">
                            <i class="text-2xl text-blue-600 hover:text-blue-800 font-bold fas fa-eye"></i>
                        </a>
                        <a class="py-2 ml-2" href="edit.php?id=<?php echo $row['userID']?>">
